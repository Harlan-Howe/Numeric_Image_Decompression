...
public class NID
{
    ...
    public static void main(String[] args)
    {
        ...
        // reinstate the following line when you have an exit condition from the while loop:
        //System.out.println("Done."); // this is commented out temporarily since you won't ever get here until there is
                                       //    a "break" in the loop.
    }
